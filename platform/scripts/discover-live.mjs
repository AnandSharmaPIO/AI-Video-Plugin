 ...
 *
 * Usage:
 *   node platform/scripts/discover-live.mjs walkthroughs/<id> [--headed] [--max-pages N]
 *
 * Output: walkthroughs/<id>/knowledge/discovery-raw.json — per page: url, headings,
...
const out = path.join(projectDir, 'knowledge', 'discovery-raw.json');
