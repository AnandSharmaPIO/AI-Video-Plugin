...
Platform copy — serves ANY feature folder via --dir:
  <venv-python> platform/tts/build_narrated.py --dir walkthroughs/<p>/modules/<m>/features/<f>
...
Output: <dir>/generated/walkthrough-narrated.mp4
...
def main():
    ...
    out = Path(args.out) if args.out else gen / "walkthrough-narrated.mp4"
