...
Run from the **content root** (any immediate subdirectory containing a
`project.yaml` is a project) — the engine resolves the content catalog from
...
Report the output path `<feature>/generated/final-video.mp4`, then
