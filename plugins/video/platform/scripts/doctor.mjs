...
import { repoRoot, pluginRoot, parseArgs, venvPython, listProjectDirs } from './lib/common.mjs';
...
try {
  for (const projectDir of listProjectDirs()) {
    const proj = parse(fs.readFileSync(path.join(projectDir, 'project.yaml'), 'utf8'));
